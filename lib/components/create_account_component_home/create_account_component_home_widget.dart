...
import 'create_account_component_home_model.dart';
export 'create_account_component_home_model.dart';

class CreateAccountComponentHomeWidget extends StatefulWidget {
  const CreateAccountComponentHomeWidget({super.key});

  @override
  State<CreateAccountComponentHomeWidget> createState() =>
      _CreateAccountComponentHomeWidgetState();
}

class _CreateAccountComponentHomeWidgetState
    extends State<CreateAccountComponentHomeWidget> {
  late CreateAccountComponentHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountComponentHomeModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Form(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(50.0, 20.0, 50.0, 30.0),
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                                ...
                                if (_model.checkboxValue!) {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title:
                                            Text('Agree to terms and service'),
                                        content: Text(
                              ...
                              text: 'Create Account - Connect Twitter',
