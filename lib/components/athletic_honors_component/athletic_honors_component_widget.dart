...
import 'athletic_honors_component_model.dart';
export 'athletic_honors_component_model.dart';

class AthleticHonorsComponentWidget extends StatefulWidget {
  const AthleticHonorsComponentWidget({super.key});

  @override
  State<AthleticHonorsComponentWidget> createState() =>
      _AthleticHonorsComponentWidgetState();
}

class _AthleticHonorsComponentWidgetState
    extends State<AthleticHonorsComponentWidget> {
  late AthleticHonorsComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AthleticHonorsComponentModel());
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await UsersAthleticAccomplishmentsRecord.createDoc(
                              currentUserReference!)
                          .set(createUsersAthleticAccomplishmentsRecordData(
