...
import 'create_account_component_page_model.dart';
export 'create_account_component_page_model.dart';

class CreateAccountComponentPageWidget extends StatefulWidget {
  const CreateAccountComponentPageWidget({super.key});

  @override
  State<CreateAccountComponentPageWidget> createState() =>
      _CreateAccountComponentPageWidgetState();
}

class _CreateAccountComponentPageWidgetState
    extends State<CreateAccountComponentPageWidget> {
  late CreateAccountComponentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountComponentPageModel());
