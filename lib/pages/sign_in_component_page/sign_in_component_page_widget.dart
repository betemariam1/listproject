...
import 'sign_in_component_page_model.dart';
export 'sign_in_component_page_model.dart';

class SignInComponentPageWidget extends StatefulWidget {
  const SignInComponentPageWidget({
    super.key,
    this.email,
  });
  ...
  @override
  State<SignInComponentPageWidget> createState() =>
      _SignInComponentPageWidgetState();
}

class _SignInComponentPageWidgetState extends State<SignInComponentPageWidget> {
  late SignInComponentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignInComponentPageModel());
                                          ...
                                          context.pushNamedAuth(
                                            ...
                                            queryParameters: {
                                              'twitterUserReference':
                                                  serializeParam(
                                                currentUserDocument?.twitterData
                                                    ?.twitterUserRef,
