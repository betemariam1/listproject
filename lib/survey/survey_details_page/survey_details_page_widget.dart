...
import 'survey_details_page_model.dart';
export 'survey_details_page_model.dart';

class SurveyDetailsPageWidget extends StatefulWidget {
  const SurveyDetailsPageWidget({
    super.key,
    required this.twitterUserReference,
  });

  final DocumentReference? twitterUserReference;

  @override
  State<SurveyDetailsPageWidget> createState() =>
      _SurveyDetailsPageWidgetState();
}

class _SurveyDetailsPageWidgetState extends State<SurveyDetailsPageWidget>
    with TickerProviderStateMixin {
  late SurveyDetailsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyDetailsPageModel());
    ...
    _model.textFieldTFBFocusNode ??= FocusNode();

    _model.textFieldOutfieldVelocityFocusNode ??= FocusNode();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                                                    ...
                                                    child:
                                                      ...
                                                      submitAction: () async {
                                                        await widget!
                                                          ...
                                                          ...createTwitterUsersRecordData(
                                                            ...
                                                            nameData:
                                                                createDataFieldStruct(
                                                              value:
                                                                  '${_model.textFieldFirstNameTextController.text} ${_model.textFieldLastNameTextController.text}',
                                                              name: 'Name',
                                                              clearUnsetFields:
                                                                  false,
                                                            ),
                                                            ...
                                                            positions:
                                                                createDataFieldStruct(
                                                              value:
                                                                  '${_model.dropDownPrimaryPosValue}-${_model.dropDownSecondaryPosValue}',
                                                              name: 'Positions',
                                                              clearUnsetFields:
                                                                  false,
                                                            ),
                                                            ...
                                                            ofv:
                                                              ...
                                                              value: int.tryParse(
                                                                  _model
                                                                      .textFieldOutfieldVelocityTextController
                                                                      .text),
                                                              clearUnsetFields:
                                                                  false,
                                                            ),
                                                        ...
                                                        while (_model
                                                            ...
                                                            FFAppState()
                                                                .index) {
                                                          await TwitterUserCollegeRecord
                                                                  .createDoc(widget!
                                                                      .twitterUserReference!)
                                                              .set(
                                                                  createTwitterUserCollegeRecordData(
                                                            createdDate:
                                                                getCurrentTimestamp,
                                                            collegeRef: _model
                                                                    .selectedCollegesList[
                    ...
                    Expanded(
                      child: StreamBuilder<TwitterUsersRecord>(
                        stream: TwitterUsersRecord.getDocument(
                            widget!.twitterUserReference!),
                        builder: (context, snapshot) {
                          ...
                          final containerTwitterUsersRecord = snapshot.data!;
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          fontFamily:
                                                                              'Outfit',
                                                                          color:
                                                                              FlutterFlowTheme.of(context).fontColor,
                                                                          fontSize:
                                                                              16.0,
                                                                          letterSpacing:
                                                                              0.0,
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  controller: _model
                                                                    ...
                                                                    text: containerTwitterUsersRecord
                                                                        .firstName
                                                                        .value,
                                                                  ),
                                                                  focusNode: _model
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldWeightedGPA2TextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.gpaData.value !=
                                                                              0.0
                                                                          ? containerTwitterUsersRecord
                                                                              .gpaData
                                                                              .value
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        controller:
                                                                            _model.textFieldACTTotal22TextController ??=
                                                                                TextEditingController(
                                                                          text: containerTwitterUsersRecord.act.value != 0
                                                                              ? containerTwitterUsersRecord.act.value.toString()
                                                                              : '',
                                                                        ),
                                                                        focusNode:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          controller: _model.textFieldSATTotal22TextController ??=
                                                                              TextEditingController(
                                                                            text: containerTwitterUsersRecord.sat.value != 0
                                                                                ? containerTwitterUsersRecord.sat.value.toString()
                                                                                : '',
                                                                          ),
                                                                          focusNode:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldWeight44TextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.weight.value !=
                                                                              0.0
                                                                          ? containerTwitterUsersRecord
                                                                              .weight
                                                                              .value
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        controller:
                                                                            _model.textFieldHeightFeetTextController ??=
                                                                                TextEditingController(
                                                                          text: containerTwitterUsersRecord.heightFeet.value != 0.0
                                                                              ? containerTwitterUsersRecord.heightFeet.value.toString()
                                                                              : '',
                                                                        ),
                                                                        focusNode:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        controller:
                                                                            _model.textFieldHeightInchesTextController ??=
                                                                                TextEditingController(
                                                                          text: containerTwitterUsersRecord.heightInches.value != 0.0
                                                                              ? containerTwitterUsersRecord.heightInches.value.toString()
                                                                              : '',
                                                                        ),
                                                                        focusNode:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      controller:
                                                                          _model.textFieldFB4SVeloHighTextController ??=
                                                                              TextEditingController(
                                                                        text: containerTwitterUsersRecord.fbHigh.value !=
                                                                                0
                                                                            ? containerTwitterUsersRecord.fbHigh.value.toString()
                                                                            : '',
                                                                      ),
                                                                      focusNode:
                                                                          _model
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      controller:
                                                                          _model.textFieldFB4SVeloAverageTextController ??=
                                                                              TextEditingController(
                                                                        text: containerTwitterUsersRecord.fbLow.value !=
                                                                                0
                                                                            ? containerTwitterUsersRecord.fbLow.value.toString()
                                                                            : '',
                                                                      ),
                                                                      focusNode:
                                                                          _model
                                                                ...
                                                                child: Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        TextFormField(
                                                                      controller:
                                                                          _model.textFieldTFBTextController ??=
                                                                              TextEditingController(
                                                                        text: containerTwitterUsersRecord.topFb.value !=
                                                                                0
                                                                            ? containerTwitterUsersRecord.topFb.value.toString()
                                                                            : '',
                                                                      ),
                                                                      focusNode:
                                                                          _model
                                                                              .textFieldTFBFocusNode,
                                                                      onChanged:
                                                                          (_) =>
                                                                              EasyDebounce.debounce(
                                                                        '_model.textFieldTFBTextController',
                                                                      ...
                                                                      keyboardType: const TextInputType
                                                                          ...
                                                                          decimal:
                                                                              true),
                                                                      validator: _model
                                                                          .textFieldTFBTextControllerValidator
                                                                          .asValidator(
                                                                              context),
                                                                    ),
                                                                  ),
                                                                ...
                                                                child: Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        TextFormField(
                                                                      controller:
                                                                          _model.textFieldOutfieldVelocityTextController ??=
                                                                              TextEditingController(
                                                                        text: containerTwitterUsersRecord.ofv.value !=
                                                                                0
                                                                            ? containerTwitterUsersRecord.ofv.value.toString()
                                                                            : '',
                                                                      ),
                                                                      focusNode:
                                                                          _model
                                                                              .textFieldOutfieldVelocityFocusNode,
                                                                      onChanged:
                                                                          (_) =>
                                                                              EasyDebounce.debounce(
                                                                        '_model.textFieldOutfieldVelocityTextController',
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldSLVeloHighTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.slHigh.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .slHigh
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldSLVeloAverageTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.slLow.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .slLow
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldCHVeloHighTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.chHigh.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .chHigh
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldFBCHVeloAverageTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.chLow.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .chLow
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldCBVeloHighTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.cbHigh.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .cbHigh
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldCBVeloAverageTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.cbLow.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .cbLow
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textField60TimeTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.time60.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .time60
                                                                              .value
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model.textFieldEVTextController ??=
                                                                            TextEditingController(
                                                                      text: containerTwitterUsersRecord.ev.value !=
                                                                              0
                                                                          ? containerTwitterUsersRecord
                                                                              .ev
                                                                              .value
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      controller:
                                                                          _model.textFieldPopTimeTextController ??=
                                                                              TextEditingController(
                                                                        text: containerTwitterUsersRecord.poptime.value !=
                                                                                0.0
                                                                            ? containerTwitterUsersRecord.poptime.value.toString()
                                                                            : '',
                                                                      ),
                                                                      focusNode:
                                                                          _model
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return PromotionComponentWidget(
                                      key: Key(
                                          'Keyl8m_${listViewIndex}_of_${listViewPromotionsRecordList.length}'),
                                      promotionReference:
