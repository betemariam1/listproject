...
import 'survey_details_page_old_widget.dart' show SurveyDetailsPageOldWidget;
...
class SurveyDetailsPageOldModel
    extends FlutterFlowModel<SurveyDetailsPageOldWidget> {
  ///  Local state fields for this page.

  String selectedOption = 'Personal';

  bool istakingSAT = false;

  bool istakingACT = false;
  ...
  List<UsersRecord>? getAdminsCopy;
  ...
  // State field(s) for TextFieldFB2SVeloHigh widget.
  FocusNode? textFieldFB2SVeloHighFocusNode;
  TextEditingController? textFieldFB2SVeloHighTextController;
  String? Function(BuildContext, String?)?
      textFieldFB2SVeloHighTextControllerValidator;
  String? _textFieldFB2SVeloHighTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return ' ';
    }
  ...
  // State field(s) for TextFieldFB2SVeloAverage widget.
  FocusNode? textFieldFB2SVeloAverageFocusNode;
  TextEditingController? textFieldFB2SVeloAverageTextController;
  String? Function(BuildContext, String?)?
      textFieldFB2SVeloAverageTextControllerValidator;
  String? _textFieldFB2SVeloAverageTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return ' ';
    }
  ...
  // State field(s) for TextFieldFTOFFMound widget.
  FocusNode? textFieldFTOFFMoundFocusNode;
  TextEditingController? textFieldFTOFFMoundTextController;
  String? Function(BuildContext, String?)?
      textFieldFTOFFMoundTextControllerValidator;
  String? _textFieldFTOFFMoundTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return ' ';
    }
  ...
  void initState(BuildContext context) {
    ...
    textFieldFB2SVeloHighTextControllerValidator =
        _textFieldFB2SVeloHighTextControllerValidator;
    textFieldFB2SVeloAverageTextControllerValidator =
        _textFieldFB2SVeloAverageTextControllerValidator;
    textFieldSLVeloHighTextControllerValidator =
    ...
    textFieldFTOFFMoundTextControllerValidator =
        _textFieldFTOFFMoundTextControllerValidator;
  }
  ...
  void dispose() {
    ...
    textFieldFB2SVeloHighFocusNode?.dispose();
    textFieldFB2SVeloHighTextController?.dispose();

    textFieldFB2SVeloAverageFocusNode?.dispose();
    textFieldFB2SVeloAverageTextController?.dispose();
    ...
    textFieldFTOFFMoundFocusNode?.dispose();
    textFieldFTOFFMoundTextController?.dispose();
