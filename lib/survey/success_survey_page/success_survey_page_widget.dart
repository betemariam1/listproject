...
import 'success_survey_page_model.dart';
export 'success_survey_page_model.dart';

class SuccessSurveyPageWidget extends StatefulWidget {
  const SuccessSurveyPageWidget({super.key});

  @override
  State<SuccessSurveyPageWidget> createState() =>
      _SuccessSurveyPageWidgetState();
}

class _SuccessSurveyPageWidgetState extends State<SuccessSurveyPageWidget>
    with TickerProviderStateMixin {
  late SuccessSurveyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuccessSurveyPageModel());
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(),
                              child: Text(
                                'If you would like to make updates, please login to your account at Academic Ballers',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(),
                              child: Text(
                                'You may have to \'reset\' your password the first time you try to login',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return PromotionComponentWidget(
                                      key: Key(
                                          'Key2w0_${listViewIndex}_of_${listViewPromotionsRecordList.length}'),
                                      promotionReference:
